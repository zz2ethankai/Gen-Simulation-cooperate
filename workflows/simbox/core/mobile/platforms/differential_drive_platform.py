"""Differential-drive mobile base platform profile."""
...
class DifferentialDrivePlatform(MobileBasePlatform):
    profile_name = "differential_drive"
    aliases = ("diff_drive", "omron_diff_drive", "panda_omron_base")
    ...
    def build_bridge(self, robot, *, node_name: str):
        from workflows.simbox.core.mobile.bridge.differential_drive_bridge import DifferentialDriveBridge

        return DifferentialDriveBridge(robot, node_name=node_name)
