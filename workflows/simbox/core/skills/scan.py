...
class Scan(BaseSkill):
    def __init__(self, robot: Robot, skill_runtime, task: BaseTask, cfg: DictConfig, *args, **kwargs):
        ...
        self.manip_list = []
        # Scan is a non-manipulation observation Skill.  Keep it outside the
        # MotionPlanner command path even though controllers expose a runtime
        # port for operation Skills.
        self._passthrough = True
        self.robot_ee_path = ""
        self.robot_base_path = ""
        self.pickcontact_view = None
